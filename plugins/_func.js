...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'umardevil48@gmail.com', true],
         [owner[1], await this.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'umardevil48@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
...
'https://tinyurl.com/2c82ajhq', 'https://tinyurl.com/265y8p3e'])
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					title: " 「 Sɪᴍᴩʟᴇ Wʜᴀᴛꜱᴀᴩᴩ Bᴏᴛ Ʋᴍᴀʀ 」",
					body: '\t' + me,
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"Hi Lol","h": `${me}`, 'jpegThumbnail': fs.readFileSync('./me.png')}}
           }
       ...
       key: {
                   fromMe: false,
                   participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "923165123719@s.whatsapp.net" } : {})
               },
               message: {
                   "productMessage": {
                       "product": {
